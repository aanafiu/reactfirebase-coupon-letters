    ...
    <div>
      <footer className="footer footer-center bg-navBg border-t-2 text-primary-content p-10">
        ...
        <nav className="w-full flex flex-col md:flex-row justify-between">
          <p className="text-lg">
            Copyright © {new Date().getFullYear()} - All right reserved By Nafiu
          </p>
          <div className="grid grid-flow-col gap-4 text-3xl">
            <Link
              target="_blank"
              to="https://github.com/aanafiu"
              className="rounded-badge border-2 border-purple-500 hover:text-navText hover:bg-purple-500"
            >
              <FaGithub />
            </Link>
            <Link
              target="_blank"
              to="https://www.linkedin.com/in/aanafiu/"
              className="rounded-badge border-2 border-purple-500 hover:text-navText hover:bg-purple-500"
            >
              <TiSocialFacebook />
            </Link>
