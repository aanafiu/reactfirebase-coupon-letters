...
const ForgetPassword = () => {
    const navigate = useNavigate();
        const { resetPassword, email} = useContext(UserContext);
    const handleReset =(e)=>{
        e.preventDefault();
    ...
    return (
        <div className="flex w-full flex-col justify-center items-center py-5 gap-6">
            ...
            <input value={email ? email : ""} type="email" placeholder="Enter Your Email Address" name="email" className="text-xl p-3 rounded-lg w-full outline-none focus:outline-purple-500"  />
